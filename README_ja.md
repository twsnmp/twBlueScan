...
- 2026/03/26: v3.1.0 Inkbird センサーに対応、UUID 追跡機能とデバイスカウント報告機能を追加
- 2026/04/18: v3.1.1 Inkbird IAM-T1 センサーの気圧データに対応
- 2026/05/26: v3.1.2 MQTTトピックにスキャンしたデバイスのMACアドレスを追加してデータ混在を防止、およびタイポやシャドウイングなどの修正。
- 2026/06/11: v3.2.0 MQTTトピックとJSONペイロードにホスト識別子を追加（-host オプションの追加）。
